    ...
    <div className='page'>
      ...
      <div className='set-stats-screen'>
        <div className='stat-inputs'>
          Name:
          <input value={stats.name} type='text' onChange={(e) => setStats({
            ...stats,
            name: e.target.value,
          })} />
          Health: 
          <input value={stats.health} type='number' onChange={(e) => setStats({
            ...stats,
            health: e.target.value,
          })} />
          Strength: 
          <input value={stats.strength} type='number' onChange={(e) => setStats({
            ...stats,
            strength: e.target.value,
          })} />
          Defense: 
          <input value={stats.defense} type='number' onChange={(e) => setStats({
            ...stats,
            defense: e.target.value,
          })} />
          Accuracy: 
          <input value={stats.accuracy} type='number' onChange={(e) => setStats({
            ...stats,
            accuracy: e.target.value,
          })} />
        </div>
        <button onClick={() => uploadCard()}>Upload Card</button>
      </div>
    </div>
  )
}
